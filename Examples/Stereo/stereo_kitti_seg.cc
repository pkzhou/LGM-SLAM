...
int main(int argc, char **argv)
{
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        SLAM.TrackStereo(imLeft,imRight,imSeg,tframe);
                ...
                vector<string> &vstrImageRight, vector<string> &vstrImageSeg, vector<double> &vTimestamps)
{
    ...
    string strPrefixSeg = strPathToSequence + "/seg_left/";
    ...
    for(int i=0; i<nTimes; i++)
    {
        ...
        vstrImageSeg[i] = strPrefixSeg + ss.str() + "_raw.png";
        //vstrImageSeg[i] = strPrefixSeg +"06_000000.png";
    }
}
